...
class ScheduleCreateDetailPage extends StatefulWidget {
  final List<String> imagePaths;
  final int currentIndex;

  const ScheduleCreateDetailPage(
      {Key key, @required this.imagePaths, @required this.currentIndex})
      : super(key: key);
  @override
  _ScheduleCreateDetailPageState createState() =>
      _ScheduleCreateDetailPageState();
}

class _ScheduleCreateDetailPageState extends State<ScheduleCreateDetailPage> {
  int _currentIndex;

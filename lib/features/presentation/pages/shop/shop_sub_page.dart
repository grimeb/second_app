...
import 'package:second_app/features/presentation/pages/shop/shop_detail_page.dart';
import 'package:tuple/tuple.dart';

class StoreSubPage extends StatelessWidget {
  ...
  PageRoute<Object> _createTutorialDetailRoute(desc, imageUrl, videoUrl) {
    return PageRouteBuilder(
      ...
      pageBuilder: (context, animation, secondaryAnimation) => StoreDetailPage(
        heroTag: imageUrl,
        desc: desc,
        videoUrl: videoUrl,
      ),
